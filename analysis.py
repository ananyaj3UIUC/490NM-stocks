...
for i in energy_company_tags:
    data_energy, info_energy = time_series.get_daily_adjusted(i, outputsize = 417)
...
for i in finance_company_tags:
    data_finance, info_finance = time_series.get_daily_adjusted(i, outputsize = 417)
...
for i in healthcare_company_tags:
    data_healthcare, info_healthcare  = time_series.get_daily_adjusted(i, outputsize = 417)
...
for i in retail_company_tags:
    data_retail, info_retail  = time_series.get_daily_adjusted(i, outputsize = 417)
